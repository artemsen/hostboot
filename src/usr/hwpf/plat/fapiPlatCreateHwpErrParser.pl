...
print TGFILE "#ifndef UNALIGNED_DATA_READ\n";
print TGFILE "#define UNALIGNED_DATA_READ\n";
print TGFILE "// Safe assigment from unaligned pointer\n";
print TGFILE "template<typename T> struct unaligned_data { T value; } __attribute__ ((packed));\n";
print TGFILE "#define INT16_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<int16_t>*>(ptr)->value)\n";
print TGFILE "#define INT32_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<int32_t>*>(ptr)->value)\n";
print TGFILE "#define INT64_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<int64_t>*>(ptr)->value)\n";
print TGFILE "#define UINT16_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<uint16_t>*>(ptr)->value)\n";
print TGFILE "#define UINT32_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<uint32_t>*>(ptr)->value)\n";
print TGFILE "#define UINT64_FROM_PTR(ptr) (reinterpret_cast<unaligned_data<uint64_t>*>(ptr)->value)\n";
print TGFILE "#endif // UNALIGNED_DATA_READ\n";
print TGFILE "\n";
...
foreach my $argnum (1 .. $#ARGV)
{
    ...
    foreach my $registerFfdc (@{$errors->{registerFfdc}})
    {
        ...
        print TGFILE "            {\n";
        print TGFILE "                i_parser.PrintNumber(\"Chip Position:\",\"%X\",ntohl(UINT32_FROM_PTR(l_pBuffer)));\n";
